...
class VanzariFormAdd extends React.Component {

    constructor(props) {
        super(props);
        this.toggleForm = this.toggleForm.bind(this);
        this.reloadHandler = this.props.reloadHandler;
        this.submitVanzare = this.submitVanzare.bind(this);
    ...
    submitVanzare(vanzare) {
        return API_VANZARE.insertVanzari(vanzare, (result, status, error) => {
            //console.log(result);
            ...
            <div style={{backgroundColor: '#496185'}}>
                ...
                <Row>
                    <Col sm={{size: '4', offset: 5}}>
                        <Button style={buttonStyle1} type={"submit"} disabled={!this.state.formIsValid} onClick={() => this.handleSubmit()}>  Add </Button>
                    </Col>
                </Row>
...
export default withRouter(VanzariFormAdd);
